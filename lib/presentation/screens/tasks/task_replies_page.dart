// lib/features/task/presentation/pages/task_replies_page.dart
              ...
              child: Column(
                ...
                children: [
                  ...
                  Card(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          _buildDetailRow('Task Title', singleTask.task.task),
                          const Divider(height: 20, thickness: 1),
                          _buildDetailRow('Project', singleTask.project_name),
                          _buildDetailRow('Assigned To', singleTask.user_name),
                  ...
                  if (singleTask.replies.isNotEmpty)
                    TaskRepliesList(replies: singleTask.replies)
                  else
                    const Center(
                      child: Padding(
